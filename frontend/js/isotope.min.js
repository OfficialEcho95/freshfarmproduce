...
})), (function (t, e) { typeof define === 'function' && define.amd ? define('ev-emitter/ev-emitter', e) : typeof module === 'object' && module.exports ? module.exports = e() : t.EvEmitter = e(); }(typeof window !== 'undefined' ? window : this, () => { function t() {} const e = t.prototype; return e.on = function (t, e) { if (t && e) { const i = this._events = this._events || {}; const o = i[t] = i[t] || []; return o.indexOf(e) == -1 && o.push(e), this; } }, e.once = function (t, e) { if (t && e) { this.on(t, e); const i = this._onceEvents = this._onceEvents || {}; const o = i[t] = i[t] || {}; return o[e] = !0, this; } }, e.off = function (t, e) { const i = this._events && this._events[t]; if (i && i.length) { const o = i.indexOf(e); return o != -1 && i.splice(o, 1), this; } }, e.emitEvent = function (t, e) { const i = this._events && this._events[t]; if (i && i.length) { let o = 0; let n = i[o]; e = e || []; for (let s = this._onceEvents && this._onceEvents[t]; n;) { const r = s && s[n]; r && (this.off(t, n), delete s[n]), n.apply(this, e), o += r ? 0 : 1, n = i[o]; } return this; } }, t; })), (function (t, e) {
...
})), (function (t, e) { typeof define === 'function' && define.amd ? define('fizzy-ui-utils/utils', ['desandro-matches-selector/matches-selector'], (i) => e(t, i)) : typeof module === 'object' && module.exports ? module.exports = e(t, require('desandro-matches-selector')) : t.fizzyUIUtils = e(t, t.matchesSelector); }(window, (t, e) => { const i = {}; i.extend = function (t, e) { for (const i in e)t[i] = e[i]; return t; }, i.modulo = function (t, e) { return (t % e + e) % e; }, i.makeArray = function (t) { let e = []; if (Array.isArray(t))e = t; else if (t && typeof t === 'object' && typeof t.length === 'number') for (let i = 0; i < t.length; i++)e.push(t[i]); else e.push(t); return e; }, i.removeFrom = function (t, e) { const i = t.indexOf(e); i != -1 && t.splice(i, 1); }, i.getParent = function (t, i) { for (;t.parentNode && t != document.body;) if (t = t.parentNode, e(t, i)) return t; }, i.getQueryElement = function (t) { return typeof t === 'string' ? document.querySelector(t) : t; }, i.handleEvent = function (t) { const e = `on${t.type}`; this[e] && this[e](t); }, i.filterFindElements = function (t, o) { t = i.makeArray(t); const n = []; return t.forEach((t) => { if (t instanceof HTMLElement) { if (!o) return void n.push(t); e(t, o) && n.push(t); for (let i = t.querySelectorAll(o), s = 0; s < i.length; s++)n.push(i[s]); } }), n; }, i.debounceMethod = function (t, e, i) { const o = t.prototype[e]; const n = `${e}Timeout`; t.prototype[e] = function () { const t = this[n]; t && clearTimeout(t); const e = arguments; const s = this; this[n] = setTimeout(() => { o.apply(s, e), delete s[n]; }, i || 100); }; }, i.docReady = function (t) { const e = document.readyState; e == 'complete' || e == 'interactive' ? setTimeout(t) : document.addEventListener('DOMContentLoaded', t); }, i.toDashed = function (t) { return t.replace(/(.)([A-Z])/g, (t, e, i) => `${e}-${i}`).toLowerCase(); }; const o = t.console; return i.htmlInit = function (e, n) { i.docReady(() => { const s = i.toDashed(n); const r = `data-${s}`; const a = document.querySelectorAll(`[${r}]`); const u = document.querySelectorAll(`.js-${s}`); const h = i.makeArray(a).concat(i.makeArray(u)); const d = `${r}-options`; const l = t.jQuery; h.forEach((t) => { let i; const s = t.getAttribute(r) || t.getAttribute(d); try { i = s && JSON.parse(s); } catch (a) { return void (o && o.error(`Error parsing ${r} on ${t.className}: ${a}`)); } const u = new e(t, i); l && l.data(t, n, u); }); }); }, i; })), (function (t, e) { typeof define === 'function' && define.amd ? define('outlayer/item', ['ev-emitter/ev-emitter', 'get-size/get-size'], e) : typeof module === 'object' && module.exports ? module.exports = e(require('ev-emitter'), require('get-size')) : (t.Outlayer = {}, t.Outlayer.Item = e(t.EvEmitter, t.getSize)); }(window, (t, e) => {
...
})), (function (t, e) { typeof define === 'function' && define.amd ? define(['outlayer/outlayer', 'get-size/get-size', 'desandro-matches-selector/matches-selector', 'fizzy-ui-utils/utils', 'isotope/js/item', 'isotope/js/layout-mode', 'isotope/js/layout-modes/masonry', 'isotope/js/layout-modes/fit-rows', 'isotope/js/layout-modes/vertical'], (i, o, n, s, r, a) => e(t, i, o, n, s, r, a)) : typeof module === 'object' && module.exports ? module.exports = e(t, require('outlayer'), require('get-size'), require('desandro-matches-selector'), require('fizzy-ui-utils'), require('isotope/js/item'), require('isotope/js/layout-mode'), require('isotope/js/layout-modes/masonry'), require('isotope/js/layout-modes/fit-rows'), require('isotope/js/layout-modes/vertical')) : t.Isotope = e(t, t.Outlayer, t.getSize, t.matchesSelector, t.fizzyUIUtils, t.Isotope.Item, t.Isotope.LayoutMode); }(window, (t, e, i, o, n, s, r) => {
